...
TG4Event &TG4Event::operator=(const TG4Event & rhs)
{
   ...
   TObject::operator=(const_cast<TG4Event &>( rhs ));
...
TG4PrimaryVertex &TG4PrimaryVertex::operator=(const TG4PrimaryVertex & rhs)
{
   // This is NOT a copy operator=. This is actually a move operator= (for stl container's sake).
   // Use at your own risk!
   (void)rhs; // avoid warning about unused parameter
   TObject::operator=(const_cast<TG4PrimaryVertex &>( rhs ));
...
TG4Trajectory &TG4Trajectory::operator=(const TG4Trajectory & rhs)
{
   // This is NOT a copy operator=. This is actually a move operator= (for stl container's sake).
   // Use at your own risk!
   (void)rhs; // avoid warning about unused parameter
   TObject::operator=(const_cast<TG4Trajectory &>( rhs ));
...
TG4PrimaryParticle &TG4PrimaryParticle::operator=(const TG4PrimaryParticle & rhs)
{
   // This is NOT a copy operator=. This is actually a move operator= (for stl container's sake).
   // Use at your own risk!
   (void)rhs; // avoid warning about unused parameter
   TObject::operator=(const_cast<TG4PrimaryParticle &>( rhs ));
...
TG4TrajectoryPoint &TG4TrajectoryPoint::operator=(const TG4TrajectoryPoint & rhs)
{
   // This is NOT a copy operator=. This is actually a move operator= (for stl container's sake).
   // Use at your own risk!
   (void)rhs; // avoid warning about unused parameter
   TObject::operator=(const_cast<TG4TrajectoryPoint &>( rhs ));
...
TG4HitSegment &TG4HitSegment::operator=(const TG4HitSegment & rhs)
{
   // This is NOT a copy operator=. This is actually a move operator= (for stl container's sake).
   // Use at your own risk!
   (void)rhs; // avoid warning about unused parameter
   TObject::operator=(const_cast<TG4HitSegment &>( rhs ));
